...
export const SendIcon = (p) => (
  <svg viewBox="0 0 24 24" {...stroke} {...p}><path d="M22 2 11 13M22 2l-7 20-4-9-9-4z" /></svg>
)
export const TrashIcon = (p) => (
  <svg viewBox="0 0 24 24" {...stroke} {...p}><path d="M3 6h18M8 6V4h8v2M6 6l1 14h10l1-14M10 11v6M14 11v6" /></svg>
)
